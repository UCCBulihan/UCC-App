...
export class MenuService implements IMenuService {
    private menuItems: MenuItem[] = [
...

       {
            ...
            subMenuItems: [
                { sortOrder: 51, name: 'Line Up', iconClass: 'fa-solid fa-users-line', path: '/SundaySchool/SundaySchool' },
                { sortOrder: 52, name: 'Savings', iconClass: 'fa-solid fa-piggy-bank', path: '/savings' },
                { sortOrder: 53, name: 'Ledger', iconClass: 'fa-solid fa-book', path: '/ledger' }
            ]
        },
